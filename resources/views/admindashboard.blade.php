...
<div class="dashboard_con">
    <div class="rightcontainer">
        <img src="/images/mmsu logo.png" alt="Avatar" class="image">
...
<div class="buttondashboardcontainer">
    <a href="adminregistration"><button type="button" class="yellowbutton" style="margin-right:10px;"> View Registrants</button></a>
    <a href="admindormmain"><button type="button" class="yellowbutton" style="margin-right:10px;"> View Dorm</button></a>
</div>
    </body>
</html>