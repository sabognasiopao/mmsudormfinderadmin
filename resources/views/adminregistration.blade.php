...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <button type="button" onclick="denyregister()" style="margin-right:5%;" class="greenbutton">DENY</button>  
    <button type="button" onclick="acceptregister()" style="margin-right:1%;" class="secondyellowbutton">ACCEPT</button>
</div>
